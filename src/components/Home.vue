<template>
  <div>
    <v-parallax src="https://images.pexels.com/photos/96381/pexels-photo-96381.jpeg?w=940&h=650&cs=srgb">
      <v-layout column align-center justify-center>
        <img type="image/svg" src="../assets/logo.svg" width="500px" class="hidden-sm-and-down">
      </v-layout>
    </v-parallax>
    <v-container>
    <h1>Who We Are</h1>
